  ...
  resources: {
    users: {
      ...
      account_data: {
        title: "Account Data",
        global: "Global",
        rooms: "Spaces and Chats",
      },
    },
    rooms: {
      name: "Space and Chats |||| Spaces and Chats",
      generated_chat_name: 'chat for "%{name}"',
      fields: {
        room_id: "Space or chat ID",
        name: "Name",
        ...
        public: "Visible in spaces and chats directory",
        ...
        parent_space_helper: "Leave empty to create a federation-level feed.",
      ...
      action: {
        ...
        erase: {
          title: "Delete chat",
          content:
            "Are you sure you want to delete this chat? This cannot be undone. All messages and shared media in the room will be deleted from the server!",
          fields: {
            block: "Block and prevent users from joining the chat",
          },
          success: "Chat/s successfully deleted.",
          failure: "Chat/s could not be deleted.",
        },
        make_admin: {
          assign_admin: "Assign admin",
          title: "Assign a chat admin to %{roomName}",
          confirm: "Make admin",
          content:
          ...
          success: "The user has been set as chat admin.",
    ...
    room_directory: {
      ...
      action: {
        title: "Delete chat from directory |||| Delete %{smart_count} chats from directory",
        content:
          "Are you sure you want to remove this chat from directory? |||| Are you sure you want to remove these %{smart_count} chats from directory?",
        erase: "Delete from chat directory",
        create: "Publish in chat directory",
        send_success: "Chat successfully published.",
        send_failure: "An error has occurred.",
      },
    },
    destinations: {
