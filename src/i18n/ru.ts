  ...
  resources: {
    ...
    rooms: {
      ...
      fields: {
        ...
        subspaces: {
          label: "Подпространства", // Этот ключ уже был
          name: "Название подпространства",
          nested_name: "Название вложенного подпространства", // <-- Новый ключ
          structure_label: "Структура подпространств",
          add_top_level: "Добавить подпространство верхнего уровня",
          add_nested: "Добавить вложенное пространство", // <-- Новый ключ
        },
      },
      helper: {
