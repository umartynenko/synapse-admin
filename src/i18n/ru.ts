  ...
  resources: {
    users: {
      ...
      account_data: {
        ...
        global: "Глобальные",
        rooms: "Чаты и пространства",
      },
    },
    rooms: {
      name: "Пространство и чаты |||| Пространства и чаты",
      generated_chat_name: "чат для «%{name}»",
      fields: {
        creator: "Делегировать пространство пользователю",
        room_id: "ID пространства или чата",
        name: "Название",
        ...
        parent_space_helper: "Оставьте пустым, чтобы создать ленту на уровне Федерации",
        alias_localpart: "Псевдоним (локальная часть)",
        subspaces: {
          label: "Вложенные пространства",
          name: "Название вложенного пространства",
          nested_name: "Название вложенного пространства",
          structure_label: "Структура вложенных пространств",
          add_top_level: "Добавить вложенное пространство первого уровня",
      ...
      helper: {
        creator:
          "Выберите пользователя, которому будут делегированы права на управление пространством. По умолчанию - текущий администратор.",
      ...
      action: {
        ...
        erase: {
          title: "Удалить чат",
          content:
            "Действительно удалить этот чат? Это действие будет невозможно отменить. Все сообщения и файлы в чате будут удалены с сервера!",
          fields: {
            block: "Заблокировать и запретить пользователям присоединяться к чату",
          },
          success: "Чат/ы успешно удалены",
          failure: "Чат/ы не могут быть удалены.",
        },
        make_admin: {
          assign_admin: "Назначить администратора",
          title: "Назначить администратора чата %{roomName}",
          ...
          success: "Пользователь назначен администратором чата.",
        ...
        add_subscriber_admin_dialog: {
          ...
          success:
            "Успешно назначен 1 Абонент Администратор |||| Успешно назначено %{smart_count} Абонента Администратора |||| Успешно назначено %{smart_count} Абонентов Администраторов",
        },
    ...
    room_media: {
      ...
      helper: {
        info: "Это список медиа, которые были загружены в чат. Невозможно удалить медиа, которые были загружены в внешние медиа-репозитории.",
      },
      action: {
    ...
    room_directory: {
      ...
      action: {
        title:
          "Удалить из каталога |||| Удалить %{smart_count} чата из каталога |||| Удалить %{smart_count} чатов из каталога",
        content:
          "Действительно удалить из каталога? |||| Действительно удалить %{smart_count} чата из каталога? |||| Действительно удалить %{smart_count} чатов из каталога?",
        erase: "Удалить из каталога",
        create: "Опубликовать в каталоге",
        send_success: "Чат успешно опубликован.",
        send_failure: "Произошла ошибка.",
      },
    },
    destinations: {
